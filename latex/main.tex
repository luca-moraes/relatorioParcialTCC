...
Este trabalho propõe uma abordagem para a avaliação automática de respostas dissertativas em ambientes educacionais. Em contraposição à preferência por questões objetivas, a métrica proposta combina a presença de palavras-chave, a frequência de sentidos de palavras, a análise da sintaxe do texto e a distância semântica através do cosseno para oferecer uma solução que simplifica o processo de correção manual. Utilizando o DataSet ASQA e dados ENADE, a pesquisa busca validar a eficácia da técnica proposta considerando fatores relevantes para processamento de linguagem natural.
